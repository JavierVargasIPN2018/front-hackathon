        ...
        <body className="body">
          <div>
            <p className="contenedor">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eius veritatis dicta 
              ...
              deserunt delectus laudantium similique accusamus voluptate labore.
          ...
          <aside>
              <div className="aside">
                  <p className="contenedor asideContenido">Lorem ipsum, dolor sit amet consectetur adipisicing elit. 
                      Neque necessitatibus cumque facere aliquam eius. Quidem rem 
                      beatae magnam neque mollitia perspiciatis corrupti ullam iusto, 
                      molestiae laboriosam consectetur, quis tempore quasi.</p>
              </div>
          </aside>
        </body>
    </>
